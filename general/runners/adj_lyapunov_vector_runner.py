...
Example
-------
python ../general/runners/adj_lyapunov_vector_runner.py --exp_setup=TestRun4 --n_units=1
...
def main(args: dict, exp_setup: dict = None):
    """Run the LYAPUNOV VECTOR experiment to generate adjoint or forward
    lyapunov vectors based on the reference records
    ...
    if exp_setup is None:
        ...
        exp_file_path = pl.Path(
            "./params/experiment_setups/adj_lyapunov_vector_experiment_setups.json"
        )
    ...
    n_existing_units = lib_file_utils.count_existing_files_or_dirs(
        ...
        search_pattern="adj_lyapunov_vector*.csv",
    )
    ...
    if args["regime_start"] is None:
        ...
        start_times = r_utils.get_adj_lv_start_time(
