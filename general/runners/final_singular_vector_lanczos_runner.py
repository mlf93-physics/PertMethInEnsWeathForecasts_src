...
Example
-------
python ../general/runners/final_singular_vector_lanczos_runner.py --exp_setup=TestRun0 --n_units=1
...
def main(args: dict, exp_setup: dict = None):
    if exp_setup is None:
        ...
        exp_file_path = pl.Path(
            "./params/experiment_setups/final_singular_vector_experiment_setups.json"
        )
    ...
    n_existing_units = lib_file_utils.count_existing_files_or_dirs(
        ...
        search_pattern="final_singular_vector*.csv",
    )
