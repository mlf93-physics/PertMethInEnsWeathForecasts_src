...
python ./plotting/collect_plots.py --plot_type=nm_anal --n_profiles=1000 --tolatex -lf normal_large --save_fig --noplot --noconfirm
...
python ../general/plotting/singular_vector_plotter.py --plot_type=s_vectors_average --pert_vector_folder=low_pred/compare_pert_exp_growth_rate_it0.005/vectors --exp_folder=sv_vectors --endpoint --n_profiles=1000 --n_runs_per_profile=20 --tolatex -lf normal_small --noconfirm --save_sub_folder=appendices/extra_plots/shell_opt0.005/low_pred --save_fig_name=average_sv_vectors_with_s_values_topt0.005 --noplot --save_fig

echo "Making singular vector average plot, opt0.001"
python ../general/plotting/singular_vector_plotter.py --plot_type=s_vectors_average --pert_vector_folder=low_pred/compare_pert_exp_growth_rate_it0.001/vectors --exp_folder=sv_vectors --endpoint --n_profiles=1000 --n_runs_per_profile=20 --tolatex -lf normal_small --noconfirm --save_sub_folder=appendices/extra_plots/shell_opt0.001/low_pred --save_fig_name=average_sv_vectors_with_s_values_topt0.001 --noplot --save_fig

echo "Making suppl exp growth rate plots"
python ../general/plotting/collect_plot_comparison.py --exp_folder=low_pred/compare_pert_exp_growth_rate_it0.001 --plot_type=collect_suppl_exp_growth_rate_compare_plots --endpoint --seed_mode -pt bv bv_eof sv --n_runs_per_profile=20 --tolatex -lf two_panel --noplot --save_fig --save_sub_folder=shell_opt0.001/low_pred --save_fig_name=compare_instant_exp_growth_rates_topt0.001 --noconfirm plot_kwargs --exp_growth_type=instant
python ../general/plotting/collect_plot_comparison.py --exp_folder=low_pred/compare_pert_exp_growth_rate_it0.005 --plot_type=collect_suppl_exp_growth_rate_compare_plots --endpoint --seed_mode -pt bv bv_eof sv --n_runs_per_profile=20 --tolatex -lf two_panel --noplot --save_fig --save_sub_folder=shell_opt0.005/low_pred --save_fig_name=compare_instant_exp_growth_rates_topt0.005 --noconfirm plot_kwargs --exp_growth_type=instant
...
python plotting/compare_plot.py --n_profiles=1 --plot_type=pert_vectors3D --exp_folder=compare_pert_3dplot_with_attractor -v bv_eof bv sv lv -pt rd nm rf  --seed_mode --file_offset=0 --tolatex -lf large_double --save_fig --save_fig_name=pert_vectors_3D_v1 --noplot plot_kwargs --elev=2 --azim=-118
python plotting/compare_plot.py --n_profiles=1 --plot_type=pert_vectors3D --exp_folder=compare_pert_3dplot_with_attractor -v bv_eof bv sv lv -pt rd nm rf  --seed_mode --file_offset=0 --tolatex -lf large_double --save_fig --save_fig_name=pert_vectors_3D_v2 --noplot plot_kwargs --elev=9 --azim=-32
...
python ./plotting/plot_data.py --plot_type=nm_dist --n_profiles=5000 --ref_end_time=150 --tolatex -lf large_double --save_fig_name=l63_eigenvector_value_real_dist --save_fig --noplot --noconfirm
